...
- [sleavely/satisfactory-savegame-prometheus-exporter](https://github.com/Sleavely/satisfactory-savegame-prometheus-exporter) - Exports additional metrics to Prometheus by parsing save game files
